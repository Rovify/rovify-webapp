...
const liveStreams: LiveStream[] = [
    {
        ...
        user: {
            name: 'ElectroBeats',
            avatar: 'https://images.unsplash.com/photo-1525197133303-6346aaf5aab1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=150&q=80',
            isVerified: true
        },
        viewers: 1245,
        category: 'Music',
